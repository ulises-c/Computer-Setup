...
| Fan curve | **junction temp** | Hotspot (junction) is more conservative than edge. Stays quiet until 70 °C then ramps in 5 °C steps to 80% at 90 °C. Exactly 5 entries required on RDNA 3+. |
